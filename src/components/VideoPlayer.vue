...
export default {
    ...
    methods: {
        init() {
            this.videoCover = this.list && this.list[0] && this.list[0].list[0].video_cover;
            this.videoId = this.list && this.list[0] && this.list[0].list[0].video_id;
        ...
        async getVideoSource() {
            ...
            document.querySelector('.ylplayer-video').setAttribute("src", this.videoSourceUrl);
            document.querySelector('.ylplayer-video').setAttribute("poster", this.videoCover);
        },
        getPlayer() {
