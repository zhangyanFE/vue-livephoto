...
!function(t, e) {
    ...
    function i() {
        ...
        var r = null
          , i = null;
        return 1 === t.length ? e(t[0]) || Array.isArray(t[0]) ? i = t[0] : "string" == typeof t[0] && (r = t[0]) : 2 === t.length && ("string" == typeof t[0] && (r = t[0]),
    ...
    function h(t, e, n, r) {
        if (m(t, n)) {
            ...
            _(t, n) && c(e.value, e.oldValue) && c(t._localeMessage, i.getLocaleMessage(i.locale)) || g(t, e, n)
        }
    }
    function p(e, n, r, i) {
        if (!r.context)
    ...
    function m(e, n) {
        var r = n.context;
        return r ? !!r.$i18n || (t("VueI18n instance does not exists in Vue instance"),
        !1) : (t("Vue instance doest not exists in VNode context"),
        !1)
    }
    function _(t, e) {
        var n = e.context;
    ...
    function g(e, n, r) {
        var i, a, o = n.value, s = v(o), l = s.path, c = s.locale, u = s.args, f = s.choice;
        if (!l && !c && !u)
            return void t("value type not supported");
        if (!l)
            return void t("`path` is required in v-t directive");
        var h = r.context;
        e._vt = e.textContent = f ? (i = h.$i18n).tc.apply(i, [l, f].concat(y(c, u))) : (a = h.$i18n).t.apply(a, [l].concat(y(c, u))),
        e._locale = h.$i18n.locale,
        e._localeMessage = h.$i18n.getLocaleMessage(h.$i18n.locale)
    }
    function v(t) {
        var e, r, i, a;
        return "string" == typeof t ? e = t : n(t) && (e = t.path,
        r = t.locale,
        i = t.args,
        a = t.choice),
        {
    ...
    function y(t, e) {
        var r = [];
        return t && r.push(t),
        e && (Array.isArray(e) || n(e)) && r.push(e),
        r
    }
    function d(t) {
        d.installed = !0,
        ...
        D.config.optionMergeStrategies.i18n = function(t, e) {
            return void 0 === e ? t : e
        }
    }
    function b(t) {
        for (var e = [], n = 0, r = ""; n < t.length; ) {
            ...
            if ("{" === i) {
                ...
                for (i = t[n++]; void 0 !== i && "}" !== i; )
                    ...
                    i = t[n++];
                var o = "}" === i
                  , s = C.test(a) ? "list" : o && W.test(a) ? "named" : "unknown";
                e.push({
                    value: a,
                    type: s
                })
    ...
    function x(t) {
        var e = t.trim();
        return ("0" !== t.charAt(0) || !isNaN(t)) && (w(e) ? F(e) : "*" + e)
    }
    function T(t) {
        var e, n, r, i, a, o, s, l = [], c = -1, u = z, f = 0, h = [];
        for (h[R] = function() {
            void 0 !== n && (l.push(n),
            n = void 0)
        }
    ...
    var D, L = Object.prototype.toString, O = "[object Object]", M = Object.prototype.hasOwnProperty, A = {
        beforeCreate: function() {
            ...
            t.i18n) {
                ...
                this.$root && this.$root.$i18n && this.$root.$i18n instanceof et ? (this._i18n = this.$root.$i18n,
                this._i18n.subscribeDataChanging(this),
                this._subscribing = !0) : t.parent && t.parent.$i18n && t.parent.$i18n instanceof et && (this._i18n = t.parent.$i18n,
                this._i18n.subscribeDataChanging(this),
                this._subscribing = !0)
        },
        ...
        render: function(t, e) {
            ...
            var s = n.path
              ...
              , c = {}
              , u = n.places || {}
              , f = (Array.isArray(u) ? u.length : Object.keys(u).length,
            i.every(function(t) {
    ...
    H.prototype.parsePath = function(t) {
        var e = this._cache[t];
        return e || (e = T(t)) && (this._cache[t] = e),
        e || []
    }
    ,
    H.prototype.getPathValue = function(t, n) {
        if (!e(t))
            return null;
    ...
    ;
    var K = ["style", "currency", "currencyDisplay", "useGrouping", "minimumIntegerDigits", "minimumFractionDigits", "maximumFractionDigits", "minimumSignificantDigits", "maximumSignificantDigits", "localeMatcher", "formatMatcher"]
      , Q = /(?:@(?:\.[a-z]+)?:(?:[\w\-_|.]+|\([\w\-_|.]+\)))/g
      , X = /^@(?:\.([a-z]+))?:/
      , Y = /[()]/g
      , Z = {
      ...
      , et = function(t) {
        var e = this;
        void 0 === t && (t = {}),
        !D && "undefined" != typeof window && window.Vue && d(window.Vue);
    ...
    ,
    et.prototype._warnDefault = function(t, e, n, i, a) {
        if (!r(n))
            return n;
        if (this._missing) {
    ...
    ,
    et.prototype._interpolate = function(t, e, i, a, o, s, l) {
        if (!e)
            return null;
        var c = this._path.getPathValue(e, i);
        if (Array.isArray(c) || n(c))
            return c;
        var u;
        if (r(c)) {
            if (!n(e))
                return null;
            if ("string" != typeof (u = e[i]))
                return null
        } else {
            if ("string" != typeof c)
                return null;
        ...
        return (u.indexOf("@:") >= 0 || u.indexOf("@.") >= 0) && (u = this._link(t, e, u, a, o, s, l)),
        this._render(u, o, s, i)
    }
    ,
    et.prototype._link = function(t, e, n, r, i, a, o) {
        var s = this
          , l = n
          , c = l.match(Q);
        for (var u in c)
            if (c.hasOwnProperty(u)) {
                var f = c[u]
                  ...
                  , p = h[0]
                  , m = h[1]
                  , _ = f.replace(p, "").replace(Y, "");
                if (o.includes(_))
                    return l;
                o.push(_);
                var g = s._interpolate(t, e, _, r, "raw" === i ? "string" : i, "raw" === i ? void 0 : a, o);
                if (s._isFallbackRoot(g)) {
                    if (!s._root)
                        throw Error("unexpected error");
                    var v = s._root.$i18n;
                    g = v._translate(v._getMessages(), v.locale, v.fallbackLocale, _, r, i, a)
                }
                g = s._warnDefault(t, _, g, r, Array.isArray(a) ? a : [a]),
                Z.hasOwnProperty(m) && (g = Z[m](g)),
                o.pop(),
                l = g ? l.replace(f, g) : l
            }
        return l
    ...
    et.prototype._render = function(t, e, n, r) {
        ...
        return i || (i = tt.interpolate(t, n, r)),
        "string" === e ? i.join("") : i
    }
    ,
    et.prototype._translate = function(t, e, n, i, a, o, s) {
        var l = this._interpolate(e, t[e], i, a, o, s, [i]);
        return r(l) ? (l = this._interpolate(n, t[n], i, a, o, s, [i]),
        r(l) ? null : l) : l
    }
    ,
    ...
    ,
    et.prototype._i = function(t, e, n, r, i) {
    ...
    et.prototype._tc = function(t, e, n, r, a) {
        ...
        this.fetchChoice((o = this)._t.apply(o, [t, e, n, r].concat(s)), a)
    }
    ,
    ...
    ,
    et.prototype._localizeDateTime = function(t, e, n, i, a) {
        var o = e
          , s = i[o];
        if ((r(s) || r(s[a])) && (o = n,
        s = i[o]),
        ...
        return u || (u = this._dateTimeFormatters[c] = new Intl.DateTimeFormat(o,l)),
        u.format(t)
    }
    ,
    ...
    et.prototype.d = function(t) {
        ...
        var i = this.locale
          , a = null;
        return 1 === n.length ? "string" == typeof n[0] ? a = n[0] : e(n[0]) && (n[0].locale && (i = n[0].locale),
        n[0].key && (a = n[0].key)) : 2 === n.length && ("string" == typeof n[0] && (a = n[0]),
    ...
    ,
    et.prototype._localizeNumber = function(t, e, n, i, a, o) {
        var s = e
          , l = i[s];
        if ((r(l) || r(l[a])) && (s = n,
        l = i[s]),
        ...
        var c, u = l[a];
        if (o)
            c = new Intl.NumberFormat(s,Object.assign({}, u, o));
        else {
            var f = s + "__" + a;
            c = this._numberFormatters[f],
            c || (c = this._numberFormatters[f] = new Intl.NumberFormat(s,u))
        }
        return c.format(t)
    }
    ,
    ...
    et.prototype.n = function(t) {
        ...
        o = Object.keys(n[0]).reduce(function(t, e) {
            var r;
            return K.includes(e) ? Object.assign({}, t, (r = {},
            r[e] = n[0][e],
            r)) : t
        }, null)) : 2 === n.length && ("string" == typeof n[0] && (a = n[0]),
        "string" == typeof n[1] && (i = n[1])),
        this._n(t, i, a, o)
    }
    ,
    ...
    var rt;
    return Object.defineProperty(et, "availabilities", {
        get: function() {
            if (!rt) {
